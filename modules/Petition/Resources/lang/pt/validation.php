...
return [
    ...
    */
    ...
    'accepted'             => 'O campo :attribute não é válido',
    'active_url'           => 'O campo :attribute não é uma URL válida.',
    'after'                => 'O campo :attribute deve ser uma data após :date.',
    'alpha'                => 'O campo :attribute deve conter apenas letras.',
    'alpha_dash'           => 'O campo :attribute deve conter apenas letras, números e barras.',
    ...
    'confirmed'            => 'O campo :attribute de confirmação deve ser igual.',
    ...
    'mimes'                => 'O campo :attribute deve ser um arquivo com as extensões: :values.',
    'min'                  => [
        'numeric' => 'O campo :attribute não pode ser menor que :min.',
        'file'    => 'O campo :attribute não pode ser menor que :min kilobytes.',
        'string'  => 'O campo :attribute não pode ser menor que :min caracteres.',
        'array'   => 'O campo :attribute não pode ser menor que :min itens.',
    ],
    'not_in'               => 'O campo selecionado :attribute é invalido.',
    'numeric'              => 'O campo :attribute deve ser um número.',
    'regex'                => 'O campo :attribute é um formato invalido.',
    ...
    'timezone'             => 'O campo :attribute deve ser uma timezona válida.',
    'unique'               => 'O campo :attribute já está sendo usado.',
    'url'                  => 'O campo :attribute não temm um formato válido.',
