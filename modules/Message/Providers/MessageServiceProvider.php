<?php namespace Modules\Message\Providers;
...
class MessageServiceProvider extends ServiceProvider {
	...
	public function boot()
	{
        ...
        {
        	$view->widgets[] = view('message::widget');
	...
	{
		$viewPath = base_path('resources/views/modules/message');
	...
	{
		$langPath = base_path('resources/lang/modules/message');
