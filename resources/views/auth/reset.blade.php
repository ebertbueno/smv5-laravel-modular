					...
					<div class="row">
						...
						<form method="POST" action="/password/reset" class="form-horizontal col-md-6 col-md-offset-3">
								...
								<div class="form-group">
										{!! Form::label('email', trans('admin::layout.email').'*') !!}
										<input type="email" name="email" value="{{ old('email') }}" class="form-control">
								</div>

								<div class="form-group">
										{!! Form::label('password', trans('admin::layout.password')) !!}
										<input type="password" name="password"  class="form-control">
								</div>

								<div class="form-group">
										{!! Form::label('password_confirmation', trans('admin::layout.confirmation').' '.trans('admin::layout.password')) !!}
										<input type="password" name="password_confirmation"  class="form-control">
								</div>

								<div class="form-group">
										<button type="submit" class="btn btn-success">
												{{ trans('admin::profile.resetpass') }}
										</button>
								</div>
						</form>
